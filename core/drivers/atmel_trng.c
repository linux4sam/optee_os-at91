...
static TEE_Result trng_setup(const void *fdt, int nodeoffset,
				 int status __unused)
{
	size_t size = 0;
	struct clk *clk = NULL;
	...
	DMSG("atmel_trng init done\n");

	return TEE_SUCCESS;
}

static const struct generic_driver trng_driver = {
	.setup = trng_setup,
};

static const struct dt_device_match trng_match_table[] = {
	{ .compatible = "atmel,at91sam9g45-trng" },
	{ 0 }
};

const struct dt_driver trng_dt_driver __dt_driver = {
	.name = "at91sam9g45_trng",
	.type = DT_DRIVER_GENERIC,
	.match_table = trng_match_table,
	.driver = &trng_driver,
};
