...
static TEE_Result scmi_clk_node_probe(const void *fdt, int node,
...
static const struct dt_device_match scmi_clock_consumer_match_table[] = {
	{ .compatible = "scmi-clock-consumer" },
	{ }
};

DEFINE_DT_DRIVER(scmi_clock_consumer_dt_driver) = {
	.name = "scmi_clock_consumer",
	.type = DT_DRIVER_NOTYPE,
	.match_table = scmi_clock_consumer_match_table,
	.probe = scmi_clk_node_probe,
};
