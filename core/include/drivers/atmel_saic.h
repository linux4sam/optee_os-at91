...
#define		AT91_AIC_SMR_LEVEL	(0 << AT91_AIC_SMR_SRC_SHIFT)
#define		AT91_AIC_SMR_NEG_EDGE	(1 << AT91_AIC_SMR_SRC_SHIFT)
#define		AT91_AIC_SMR_HIGH_LEVEL	(2 << AT91_AIC_SMR_SRC_SHIFT)
#define		AT91_AIC_SMR_POS_EDGE	(3 << AT91_AIC_SMR_SRC_SHIFT)
